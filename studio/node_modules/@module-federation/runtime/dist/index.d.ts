import { Federation, Module, ModuleFederation, ModuleFederationRuntimePlugin, RuntimePluginHooks, UserOptions, getRemoteEntry, getRemoteInfo, loadScript, loadScriptNode, registerGlobalPlugins, satisfy } from "@module-federation/runtime-core";
...
//#endregion
export { type Federation, Module, ModuleFederation, type ModuleFederationRuntimePlugin, type RuntimePluginHooks, createInstance, getInstance, getRemoteEntry, getRemoteInfo, init, loadRemote, loadScript, loadScriptNode, loadShare, loadShareSync, preloadRemote, registerGlobalPlugins, registerPlugins, registerRemotes, registerShared, satisfy };
