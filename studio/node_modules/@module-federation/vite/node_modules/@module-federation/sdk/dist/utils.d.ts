...
declare function getResourceUrl(module: ModuleInfo, sourceUrl: string): string;
declare function getResourceUrl(module: ResourceUrlInfo, sourceUrl: string): string;
