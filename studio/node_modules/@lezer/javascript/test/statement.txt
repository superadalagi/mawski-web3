...
Script(
  ...
  FunctionDeclaration(function,VariableDefinition,ParamList(
    ObjectPattern(PatternProperty(VariableDefinition)),VariableDefinition,Equals,VariableName,VariableDefinition,Equals,VariableName),Block))
...
Script(
  ...
  ForStatement(for,ForInSpec(const,ObjectPattern(PatternProperty(VariableDefinition)),in,VariableName),ExpressionStatement(VariableName)),
...
Script(VariableDeclaration(
  const,
  ObjectPattern("{",PatternProperty(VariableDefinition(⚠)),"}"),
  Equals,
  ObjectExpression))
...
Script(
  ExpressionStatement(ParenthesizedExpression(AssignmentExpression(
    ObjectPattern(PatternProperty(VariableDefinition)),Equals,VariableName))),
  ...
  VariableDeclaration(let,ObjectPattern(
    PatternProperty(VariableDefinition),
