import { c as AsymmetricMatcher, r as MockMatchOptions } from "./createMockFetch-rKZ5syQ7.js";
declare module 'vitest' {
  interface Assertion<T> {
    toHaveReceivedRequest(method: string, url: string, options?: MockMatchOptions): void;
     ...
     */
    toHaveHeader(name: string | AsymmetricMatcher, value?: unknown): void;
