 ...
 */ export const cliConfigSchema = z.object({
    ...
    deployment: z.optional(z.object({
        ...
        autoUpdates: z.optional(z.boolean()),
        studioHost: z.optional(z.never({
            error: 'deployment.studioHost is not supported. Move studioHost to the top level of sanity.cli.ts, or pass --url <hostname> to sanity deploy.'
        }))
    })),
