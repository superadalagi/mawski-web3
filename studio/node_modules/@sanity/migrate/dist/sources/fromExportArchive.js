 ...
 */ export function fromExportArchive(path) {
    return _wrap_async_generator(function() {
        var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, body, header, _iteratorAbruptCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, _value1, chunk, err, err1;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 2:
                    _iterator = _async_iterator.apply(void 0, [
                        streamToAsyncIterator.apply(void 0, [
                            _state.sent().pipeThrough(createTarDecoder({
                                strict: true
                            }))
                        ])
                    ]);
                ...
                case 4:
                    ...
                    _value = _step.value;
                    body = _value.body, header = _value.header;
                ...
                case 5:
                    ...
                    _iterator1 = _async_iterator(streamToAsyncIterator(body));
                    _state.label = 6;
                case 6:
                    return [
                        4,
                ...
                case 18:
                    ...
                    return [
                        4,
                        _await_async_generator(body.cancel())
                    ];
                case 19:
                    _state.sent();
                    _state.label = 20;
