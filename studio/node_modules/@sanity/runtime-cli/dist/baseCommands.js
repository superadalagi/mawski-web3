...
import { Command, CommandHelp, Errors, Flags as OclifFlags } from '@oclif/core';
...
import { withRequestId } from './utils/request-id.js';
...
export class RuntimeCommand extends Command {
     ...
     */
    coreError(result) {
        const error = new Errors.CLIError(withRequestId(result.error, result.requestId), {
            suggestions: result.suggestions,
            ref: result.ref,
            code: result.code,
            exit: result.exitCode,
        });
        // oclif's toErrorJson spreads own enumerable properties into the --json error
        if (result.requestId)
            Object.assign(error, { requestId: result.requestId });
        throw error;
    }
    /**
