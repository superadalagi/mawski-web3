...
<html lang="en">
    ...
    <body>
        ...
        <nav id="sidebar" class="relative y-scroll max-h-100 pad-t-5 border-right overflow-auto nav-min-width">
          <label for="nav-toggle" id="nav-toggle-label" aria-label="Toggle Functions list" title="Toggle Functions list" class="z-10 nav-label"></label>
        ...
        <script src="./web-socket.js" type="module"></script>
    </body>
</html>
