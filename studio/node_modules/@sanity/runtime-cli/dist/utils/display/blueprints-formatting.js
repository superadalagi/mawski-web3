...
import { SANITY_ACCESS_ROBOT, SANITY_ACCESS_ROLE, SANITY_APPLICATION, SANITY_FUNCTION_DOCUMENT, SANITY_FUNCTION_DURABLE, SANITY_FUNCTION_MEDIA_LIBRARY_ASSET, SANITY_FUNCTION_PUBSUB, SANITY_FUNCTION_SCHEDULED, SANITY_FUNCTION_SYNC_TAG_INVALIDATE, SANITY_INSTALLATION_CONFIG, SANITY_PROJECT, SANITY_PROJECT_CORS, SANITY_PROJECT_DATASET, SANITY_PROJECT_WEBHOOK, SANITY_STUDIO, } from '../../constants.js';
...
const RESOURCE_CATEGORIES = {
    ...
    [SANITY_INSTALLATION_CONFIG]: {
        label: 'Installation configs',
...
/**
 * Returns hosted Studio URLs, one line per Studio from resource-ish shapes
 * Searches `parameters`, `resolvedParameters` and root for `studioHost`
 */
export function formatStudioUrls(resources) {
    ...
    for (const res of resources) {
        if (res.type !== SANITY_STUDIO)
            continue;
        const { resolvedParameters, parameters } = res;
        const host = studioHost(resolvedParameters ?? parameters ?? res);
        if (host)
