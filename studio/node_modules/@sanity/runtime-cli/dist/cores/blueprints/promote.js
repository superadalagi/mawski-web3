...
export async function blueprintPromoteCore(options) {
    ...
    try {
        ...
        if (!ok) {
            ...
            suggestions.push(`Run \`${runCommand(bin)} blueprints info\` to check the current Stack scope.`);
        ...
        try {
            ...
            return {
                ...
                suggestions: [
                    `Run \`${runCommand(bin)} blueprints config --edit\` to update your Blueprint config manually.`,
                ],
            };
        }
