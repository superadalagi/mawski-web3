...
import { a as ServerError, c as isHttpError, i as CorsOriginError, l as isQueryParseError, o as formatQueryParseError, r as ClientError, t as defineRequester, u as _defineProperty } from "./request-CYLhJzOA.js";
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await import("./browserUpload-BTQyjHMj.js"), req = _prepareRequest(client, { ...baseRequest });
