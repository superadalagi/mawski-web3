 ...
 */
export function maybeUnzip(source) {
    return maybeUnzipLayers(source, defaultMaxCompressionLayers);
}
async function* maybeUnzipLayers(source, remainingLayers) {
...
async function peekBytes(source, minimumBytes) {
...
//# sourceMappingURL=maybeUnzip.js.map