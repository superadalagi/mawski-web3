 ...
 */ export async function createDataset(options) {
    const { datasetName, embeddings, embeddingsProjection, forcePublic = false, isUnattended = false, output, projectFeatures, projectId, silent = false, visibility } = options;
