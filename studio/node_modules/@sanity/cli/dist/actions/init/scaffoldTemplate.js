...
import { getInstallCommand, installDeclaredPackages } from '../../util/packageManager/installPackages.js';
...
export async function scaffoldAndInstall({ datasetName, defaults, displayName, options, organizationId, output, outputPath, projectId, remoteTemplateInfo, sluggedName, templateName, trace, useTypeScript, workbench, workDir }) {
    const { autoUpdates, git, install, overwriteFiles, packageManager, templateToken, unattended } = options;
