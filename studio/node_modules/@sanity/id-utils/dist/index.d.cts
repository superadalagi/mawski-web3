 ...
 * If no input is provided, a random uuid will be used instead
 */
export declare function createVariantDefinitionId(
  input?: string,
): VariantDefinitionId
 ...
 * @param id - The document ID to check
 */
export declare function isVariantDefinitionId(
  id: string,
): id is VariantDefinitionId
 ...
 * @public
 */
export declare type VariantDefinitionId = Brand<string, 'variantDefinitionId'>

/**
 * @public
 */
export declare const VariantDefinitionId: Brander<VariantDefinitionId>
