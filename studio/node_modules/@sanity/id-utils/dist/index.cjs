...
var tsBrand = require("ts-brand"), uuid = require("@sanity/uuid");
const VALID_ID = /^[a-z-A-Z0-9._-]+$/, DRAFTS_DIR = "drafts", VERSION_DIR = "versions", VARIANT_DEFINITIONS_DIR = "_.variants", PATH_SEPARATOR = ".", DRAFTS_PREFIX = `${DRAFTS_DIR}${PATH_SEPARATOR}`, VERSION_PREFIX = `${VERSION_DIR}${PATH_SEPARATOR}`, VARIANT_DEFINITION_PREFIX = `${VARIANT_DEFINITIONS_DIR}${PATH_SEPARATOR}`;
...
}), VariantDefinitionId = tsBrand.make((id) => {
  validateAnyId(id), validateVariantDefinitionId(id);
});
...
function validateVariantDefinitionId(id) {
...
function isVariantDefinitionId(id) {
...
const UNSAFE_CHARS = /[^a-zA-Z0-9_-]+/g, LEADING = /^[_-]+/, TRAILING = /[_-]+$/, LATIN_LETTERS = /[\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u017f]/g, COMBINING_MARKS = /[\u0300-\u036f\ufe20-\ufe2f\u20d0-\u20ff]/g, DEBURRED_LETTERS = {
  \u00C6: "Ae",
  \u00D0: "D",
  \u00D8: "O",
  \u00DE: "Th",
...
function createVariantDefinitionId(input) {
...
exports.isVariantDefinitionId = isVariantDefinitionId;
