 ...
 * @public
 */
export declare const configDefinition: v.ObjectSchema<
  {
    readonly formatGeneratedCode: v.OptionalSchema<
      v.UnionSchema<
        [v.BooleanSchema<undefined>, v.PicklistSchema<['oxfmt', 'prettier'], undefined>],
        undefined
      >,
      true
    >
    readonly generates: v.OptionalSchema<v.StringSchema<undefined>, './sanity.types.ts'>
    readonly overloadClientMethods: v.OptionalSchema<v.BooleanSchema<undefined>, true>
    readonly path: v.OptionalSchema<
      v.UnionSchema<
        [v.StringSchema<undefined>, v.ArraySchema<v.StringSchema<undefined>, undefined>],
        undefined
      >,
      readonly [
    ...
    >
    readonly schema: v.OptionalSchema<v.StringSchema<undefined>, './schema.json'>
  },
  undefined
>
...
/** @public */
export declare type TypeGenConfig = v.InferOutput<typeof configDefinition>
