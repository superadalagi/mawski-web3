...
import { StatusEvent } from "@sanity/comlink";
 ...
 * @internal
 */
type ChannelStatusMap = ReadonlyMap<string, ChannelConnectionStatus>;
interface Context$2 {
...
declare const presentationMachine: import("xstate").StateMachine<Context$2, {
  ...
  type: "assign overlays dismissed";
  params: unknown;
} | {
  ...
  type: "notify iframe load timeout";
  params: unknown;
} | {
  type: "notify overlays connection timeout";
  params: unknown;
}, {
  type: "overlays connected";
  params: unknown;
} | {
  type: "overlays connecting";
  params: unknown;
} | {
  type: "overlays dismissed";
  params: unknown;
} | {
  type: "overlays reconnecting";
  params: unknown;
} | {
  type: "status event resolves to idle";
  params: unknown;
}, "iframe load timeout" | "overlays connection status delay" | "overlays connection timeout", {
  loaded: "refreshing" | {
    idle: "checking" | "dismissed" | "ok" | {
      connecting: "pending" | "slow" | "timedOut";
    } | {
      reconnecting: "failed" | "pending" | "slow";
    };
  } | {
    reloading: "checking" | "dismissed" | "timedOut" | "waiting";
  };
} | {
  loading: "dismissed" | "timedOut" | "waiting";
}, "busy" | "overlays connection timed out" | "prevent iframe interaction" | "show error card" | "show loading overlay" | "show overlays connection status", import("xstate").NonReducibleUnknown, import("xstate").NonReducibleUnknown, import("xstate").EventObject, import("xstate").MetaObject, {
...
//# sourceMappingURL=types-BXXMkn4Q.d.ts.map