...
declare const structureLocaleStrings: {
  ...
  'banners.obsolete-draft.actions.compare-draft.tooltip': string;
...
//# sourceMappingURL=useStructureTool-C0IQbXd6.d.ts.map